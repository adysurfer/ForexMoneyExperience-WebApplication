...
if ENV == "development":
    ...
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://yrcmhvklpgthlx' \
                                            ':1465aadda34b7d40ac8fdd5fbadda76ba347d081f79dba5584562a34d5ba30d1@ec2-52' \
                                            '-71-55-81.compute-1.amazonaws.com:5432/d6i15548f8828s'
