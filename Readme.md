...
Last Updated on Python 3.x.x: 13 May 2020

Last Updated By : Aditya

`Main Application Page:` https://forexmoneyexperience.herokuapp.com/
...
- Create `runtime.txt` file and mention runtime python version `python-3.10.2` in it
